...
공공데이터포털의 정책 원천 데이터를 수집하여 청년 관련 정책을 선별하고, 정책 카드 생성에 활용
...
정책 정보와 연결되는 법령 근거를 제공하기 위해 **법제처 국가법령정보 조문 데이터**를 활용  

| 항목 | 내용 |
|---|---|
| 데이터명 | 법제처 국가법령정보 조문 데이터 |
| 수집 건수 | 약 100건 |
| 출처 및 저작권 | 법제처 국가법령정보센터 |
| 출처 URL | https://open.law.go.kr/LSO/openApi/guideList.do |
