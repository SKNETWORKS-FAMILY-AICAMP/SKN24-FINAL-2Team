# ⚠️ 이 파일은 구버전입니다. LangGraph 멀티에이전트 시스템으로 교체됨.
# 새 진입점: agents/debate/__init__.py → build_debate_graph()
# 이 파일은 삭제 예정입니다.
"""
pipeline/pipelines/debate.py  (DEPRECATED)
→ 대체: agents/debate/graph.py
...
- 출처 URL이나 "[출처: ...]" 같은 표기를 발언 본문에 넣지 마세요.
...
_TYPE_INSTRUCTION = {
    ...
    "argument":    "구체적 근거를 포함한 세부 주장을 제시하세요. (500자 이내)",
    "rebuttal":    "상대방의 주장에 논리적으로 반박하세요. (500자 이내)",
    "response":    "상대방의 반박에 명확히 답변하세요. (500자 이내)",
    "extra_reb":   "앞선 주장에 대해 추가 반박 1회를 제시하세요. (500자 이내)",
    "extra_res":   "앞선 반박에 대해 추가 답변 1회를 제시하세요. (500자 이내)",
