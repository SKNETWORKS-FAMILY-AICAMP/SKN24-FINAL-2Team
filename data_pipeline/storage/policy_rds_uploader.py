...
def upload_policies() -> None:
    ...
    """
    from storage.policy_rds_handler import upsert_policy
    ...
    if law_path and law_path.exists():
...
def upload_news() -> None:
    ...
    → Qdrant news
    """
    from storage.policy_rds_handler import upsert_article, resolve_category_id
    ...
    for article in _read_jsonl(cleaned_path):
        ...
        data_id = upsert_article(
            keyword_name=article.get("keyword_matched", ""),
